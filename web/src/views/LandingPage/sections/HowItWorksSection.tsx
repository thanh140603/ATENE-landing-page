...
const STEPS = [
  {
    ...
    titleJa: '申し込む',
    titleEn: 'Apply',
    bodyJa: 'フォームに基本情報・希望ブランド・サンプル希望・希望レートを入力。これ1回で完了します。',
    bodyEn:
      'Enter your basic info, preferred brands, sample request, and rates in the form. One submission and you’re done.',
  },
  {
    n: '02',
    titleJa: 'サンプル受け取り',
  ...
  },
  {
    ...
    bodyJa: '予約した枠で配信。売上に応じた報酬を【サイクル：要記入】でお支払いします。',
    bodyEn: 'Go live in your reserved slot. Payouts based on sales are made on a [cycle: TBD] schedule.',
  },
] as const
...
export function HowItWorksSection() {
  ...
  return (
    <section className={`section section--warm ${styles.section}`}>
        ...
        <div className={styles.header}>
          ...
          <p className={`p ${styles.lead}`}>
            {locale === 'ja'
              ...
              : 'From application to going live to receiving rewards. You won’t get lost.'}
          </p>
        </div>
